...
<html>
    ...
    <body>
        <div class="container">
            ...
            if ($estConnecte && $_SESSION['typeUtilisateur'] == 'visiteur') {
                ?>
            <div class="header">
            ...
            <?php
            } elseif ($estConnecte && $_SESSION['typeUtilisateur'] == 'comptable') {
            ?>
                <div class="header">
                <div class="row vertical-align">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        <ul class="nav nav-pills2 pull-right" role="tablist">
                            ...
                            <li
                            <?php if ($uc == 'deconnexion') { ?>class="active"<?php } ?>>
                                <a class="orgcomptable" href="index.php?uc=deconnexion&action=demandeDeconnexion">
                                    <span class="glyphicon glyphicon-log-out"></span>
                                    Déconnexion
                                </a>
                            </li>
